export const ARTIFACT_LABELS: Record<string, string> = {
  payout: 'Payouts',
  commissions: 'Payouts',
  commission_calc: 'Payouts',
  commission_detail: 'Payouts',
  commission_base: 'Payouts',
  deal_commissions: 'Payouts',
  quarterly_commissions: 'Payouts',
  monthly_commissions: 'Payouts',
